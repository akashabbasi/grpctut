...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=akashabbasi.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x61, 0x6b, 0x61, 0x73, 0x68, 0x61, 0x62,
	0x62, 0x61, 0x73, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d, 0x65, 0x6d,
	...
	0x6f, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x61, 0x6b, 0x61, 0x73,
	0x68, 0x61, 0x62, 0x62, 0x61, 0x73, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4d,
	...
	0x03, 0x53, 0x44, 0x44, 0x10, 0x02, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x70, 0x62, 0x62,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: akashabbasi.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: akashabbasi.pcbook.Storage
	(*Memory)(nil),      // 2: akashabbasi.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: akashabbasi.pcbook.Storage.driver:type_name -> akashabbasi.pcbook.Storage.Driver
	2, // 1: akashabbasi.pcbook.Storage.memory:type_name -> akashabbasi.pcbook.Memory
